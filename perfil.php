...
<html lang="pt-br">
    ...
    <div class="navbar">
          ...
          <form action="perfil.php?id=<?php echo $dadosusuario->ID;?>" class="box" method="post">
            <h1>Perfil</h1>
            ...
            <input type="tel" name="telefone" id="telefone" placeholder="Telefone" value="<?php echo $dadosusuario->TELEFONE;?>" oninput="mascara_telefone()" required>
            <input type="text" name="endereco" id="endereco" placeholder="Endereço" value="<?php echo $dadosusuario->ENDERECO;?>" required>

            <a class="descer" href="menuprincipal.php">Menu</a>
            <a class="descer" href="alterarperfil.php?id=<?php echo $dadosusuario->ID;?>">Voltar</a>
          </form>
